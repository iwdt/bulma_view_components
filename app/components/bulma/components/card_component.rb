module Bulma
  module Components
    class CardComponent < ApplicationComponent
      # @dynamic card_image, with_card_image
      renders_one :card_image, Card::ImageComponent
      ...
      private :with_card_image
      def image(**html_attributes, &block)
        with_card_image(**html_attributes, &block)
      end
